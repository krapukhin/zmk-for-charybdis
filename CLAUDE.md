...
- `ACCEL_LOW_SPEED` (175 = 1.75 counts/ms) — below this, multiplier = 1.0
- `ACCEL_HIGH_SPEED` (3270 = 32.7 counts/ms) — above this, multiplier = max
...
- Normal: `CPI=1400`, `CPI_DIVIDOR=1` → **1400 effective**, up to 8400 with acceleration
...
- Scroll tick: `42` (~0.76 mm of ball travel per wheel tick at 1400 CPI), Caret tick: `20`
