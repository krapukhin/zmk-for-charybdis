...
- `ACCEL_LOW_SPEED` (125 = 1.25 counts/ms) — below this, multiplier = 1.0
- `ACCEL_HIGH_SPEED` (2330 = 23.3 counts/ms) — above this, multiplier = max
...
- Scroll tick: `30` (~0.76 mm of ball travel per wheel tick at 1000 CPI), Caret tick: `20`
