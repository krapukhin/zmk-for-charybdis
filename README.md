...
|------|----------|----------|
| **Normal** | default | Mouse cursor with acceleration (1000 CPI, up to 6x on a fast roll); raises the auto mouse layer |
...
CONFIG_PMW3610_SCROLL_TICK=58      # Scroll sensitivity (higher = slower); ~1.5 mm of ball travel per tick
